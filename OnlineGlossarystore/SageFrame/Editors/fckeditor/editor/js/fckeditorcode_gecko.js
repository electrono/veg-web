...
var FCK = {
    Name: FCKURLParams['InstanceName'], Status: 0, EditMode: 0, Toolbar: null, HasFocus: false, DataProcessor: new FCKDataProcessor(),
    GetInstanceObject: (function() {
        var w = window;
        return function(name) { return w[name]; }
    })(),
    AttachToOnSelectionChange: function(A) { this.Events.AttachEvent('OnSelectionChange', A); },
    GetLinkedFieldValue: function() { return this.LinkedField.value; },
...
var FCKDomTools = {
    ...
    RemoveAttributes: function(A, B) { for (var i = 0; i < B.length; i++) this.RemoveAttribute(A, B[i]); },
    ...
    ClearAllMarkers: function(A) { for (var i in A) this.ClearElementMarkers(A, A[i]['element'], true); },
...
FCKTools.ResetStyles = function(A) { A.style.cssText = 'margin:0;padding:0;border:0;background-color:transparent;background-image:none;'; };
...
FCKStyle.prototype = {
    ...
    _GetVariableReplace: function() { return this._Variables[arguments[2]] || arguments[0]; },
...
var FCKStyles = FCK.Styles = {
    ...
    CheckStyleInSelection: function(A) { return false; },
    ...
    GetStyle: function(A) { return this.GetStyles()[A]; },
    GetStyles: function() {
    ...
    CheckHasObjectStyle: function(A) { return !!this._ObjectStyles[A]; },
...
var FCKListHandler = {
    ...
    CheckEmptyList: function(A) { return (FCKDomTools.GetFirstChild(A, 'LI') == null); },
...
FCKDomRange.prototype = {
    ...
    CreateRange: function() { return new FCKW3CRange(this.Window.document); },
    ...
    InsertNode: function(A) { if (this._Range) this._Range.insertNode(A); },
    ...
    FixBlock: function(A, B) {
        ...
        if (FCKDomTools.CheckIsEmptyElement(D, function(element) { return element.getAttribute('_fck_bookmark') != 'true'; }) && FCKBrowserInfo.IsGeckoLike) FCKTools.AppendBogusBr(D);
        this.InsertNode(D);
    ...
    CheckHasRange: function() { return !!this._Range; },
...
FCKDocumentFragment.prototype = {
    AppendTo: function(A) { A.appendChild(this.RootNode); },
    AppendHtml: function(A) {
        var B = this.RootNode.ownerDocument.createElement('div');
        B.innerHTML = A;
        FCKDomTools.MoveChildren(B, this.RootNode);
    },
    InsertAfterNode: function(A) { FCKDomTools.InsertAfterNode(A, this.RootNode); }
};
...
FCKW3CRange.prototype = {
    _UpdateCollapsed: function() { this.collapsed = (this.startContainer == this.endContainer && this.startOffset == this.endOffset); },
    ...
    setStartAfter: function(A) { this.setStart(A.parentNode, FCKDomTools.GetIndexOf(A) + 1); },
    setStartBefore: function(A) { this.setStart(A.parentNode, FCKDomTools.GetIndexOf(A)); },
    setEndAfter: function(A) { this.setEnd(A.parentNode, FCKDomTools.GetIndexOf(A) + 1); },
    setEndBefore: function(A) { this.setEnd(A.parentNode, FCKDomTools.GetIndexOf(A)); },
    collapse: function(A) {
        if (A) {
            this.endContainer = this.startContainer;
...
FCKVisitLinkCommand = function() { this.Name = 'VisitLink'; };
...
var FCKNbsp = function() { this.Name = 'Non Breaking Space'; };
FCKNbsp.prototype = { Execute: function() { FCK.InsertHtml('&nbsp;'); }, GetState: function() { return (FCK.EditMode != 0 ? -1 : 0); } };
