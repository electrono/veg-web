        ...
        return {
            ...
            onOk: function() {
                ...
                if (m.info) {
                    ...
                    if (!D.hasColumnHeaders && (v == 'col' || v == 'both'))
                    ...
                    var B = [];
                    if (n.txtHeight) k.setStyle('height', CKEDITOR.tools.cssLength(n.txtHeight));
                ...
                if (!D._.selectedElement) e.insertElement(k);
                else i.selectBookmarks(j);
                return true;
            },
            contents: [{
                id: 'info',
                ...
                elements: [{
                    ...
                    children: [{
                        ...
                        padding: 0,
                        children: [{
                            type: 'text', id: 'txtRows', 'default': 3, label: e.lang.table.rows, required: true, style: 'width:5em',
                            validate: function() {
                            ...
                            type: 'text', id: 'txtCols', 'default': 2, label: e.lang.table.columns, required: true, style: 'width:5em',
                            validate: function() {
                                var i = true, j = this.getValue();
                                i = i && CKEDITOR.dialog.validate.integer()(j) && j > 0;
                                if (!i) {
                            ...
                            setup: function(i) { this.setValue(i.$.rows[0].cells.length); },
                            commit: c
                        }, { type: 'html', html: '&nbsp;' }, {
                            ...
                            setup: function(i) { this.setValue(i.getAttribute('border') || ''); },
                            commit: function(i, j) {
                        ...
                        children: [{
                            ...
                            children: [{
                                type: 'text', id: 'txtWidth', style: 'width:5em', label: e.lang.common.width, 'default': 500, validate: CKEDITOR.dialog.validate.number(e.lang.table.invalidWidth),
                                onLoad: function() {
                                ...
                                onChange: function() { this.getDialog().getContentElement('info', 'txtWidth').onChange(); },
                                commit: c
                            }]
                        }, {
                            type: 'hbox', widths: ['5em'],
                            children: [{
                                type: 'text', id: 'txtHeight', style: 'width:5em', label: e.lang.common.height, 'default': '', validate: CKEDITOR.dialog.validate.number(e.lang.table.invalidHeight),
                                onLoad: function() {
                            ...
                            type: 'text', id: 'txtCellPad', style: 'width:3em', label: e.lang.table.cellPad, 'default': 1, validate: CKEDITOR.dialog.validate.number(e.lang.table.invalidCellPadding), setup: function(i) { this.setValue(i.getAttribute('cellPadding') || ''); },
                            commit: function(i, j) {
