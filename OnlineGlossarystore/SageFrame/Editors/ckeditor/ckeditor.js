...
(function() {
    if (!window.CKEDITOR)
        window.CKEDITOR = (function() {
            var a = {
                timestamp: 'ABLC4TW', version: '3.5', revision: '6260', _: { }, status: 'unloaded',
                basePath: (function() {
    ...
    if (!a.env)
        a.env = (function() {
            var b = navigator.userAgent.toLowerCase(), c = window.opera, d = {
                ie: /*@cc_on!@*/false, opera: !!c && c.version, webkit: b.indexOf(' applewebkit/') > -1, air: b.indexOf(' adobeair/') > -1, mac: b.indexOf('macintosh') > -1, quirks: document.compatMode == 'BackCompat', mobile: b.indexOf('mobile') > -1,
    ...
    e.extend(h.prototype, {
        ...
        getDirection: function(i) { return i ? this.getComputedStyle('direction') : this.getStyle('direction') || this.getAttribute('dir'); },
        data: function(i, j) {
            i = 'data-' + i;
    ...
    (function() {
        ...
        a.htmlParser.fragment.fromHtml = function(p, q) {
            ...
            function B(E, F, G) {
                ...
                if (q && !F.type) {
                    var H, I;
                    if (E.attributes && (I = E.attributes['data-cke-real-element-type'])) H = I;
                    else H = E.name;
    ...
    (function() {
        ...
        var o = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/ , p = d.walker.whitespaces(1), q = d.walker.bookmark(0, 1), r = function(s) { return q(s) && p(s); };
    ...
    (function() {
        var l = function(t) { t.collapsed = t.startContainer && t.endContainer && t.startContainer.equals(t.endContainer) && t.startOffset == t.endOffset; }, m = function(t, u, v) {
            t.optimizeBookmark();
                    ...
                    while (y || z) {
                        ...
                        while (z) {
                            ...
                            if (z.type == 3) {
                                ...
                                if ( /[^\s\ufeff]/ .test(D)) z = null;
                                C = /[\s\ufeff]$/ .test(D);
                            } else if (z.$.offsetWidth > 0 && !z.data('cke-bookmark'))
    ...
    j.add('basicstyles', {
        ...
        init: function(m) {
            var n = function(q, r, s, t) {
                var u = new a.style(t);
                m.attachStyleStateChange(u, function(v) { m.getCommand(s).setState(v); });
    ...
    (function() {
        ...
        function r(w) {
            ...
            if (z && x.lang.dir != z.getComputedStyle('direction')) y.addClass('cke_mixed_dir_content');
            else y.removeClass('cke_mixed_dir_content');
        }
            ...
            return function(x) {
                ...
                if (A && A.length) {
                    ...
                    while (E = D.getNextRange(1)) {
                        ...
                        J.evaluator = function(M) { return !!(M.type == 1 && M.getName() in m && !(M.getName() == (z == 1) ? 'p' : 'div' && M.getParent().type == 1 && M.getParent().getName() == 'blockquote') && M.getPosition(K) & 2 && (M.getPosition(L) & 4 + 16) == 4); };
    ...
    a.UI_BUTTON = 1;
    k.button = function(m) {
        e.extend(this, m, { title: m.label, className: m.className || m.command && 'cke_button_' + m.command || '', click: m.click || (function(n) { n.execCommand(m.command); }) });
        this._ = { };
    };
    k.button.handler = { create: function(m) { return new k.button(m); } };
    k.button._ = {
        instances: [],
        keydown: function(m, n) {
    ...
    (function() {
        ...
        k.button.prototype = {
            ...
            render: function(o, p) {
                ...
                this._.editor = o;
                var w = {
                    id: r, button: this, editor: o,
                    focus: function() {
                        var z = a.document.getById(r);
                        z.focus();
                    },
                    execute: function() { this.button.click(o); }
                };
                w.clickFn = u = e.addFunction(w.execute, w);
                w.index = v = k.button._.instances.push(w) - 1;
                if (this.modes) {
                    var x = { };
                    o.on('beforeModeUnload', function() { x[o.mode] = this._.state; }, this);
                    o.on('mode', function() {
                        var z = o.mode;
    ...
    a.on('reset', function() { k.button._.instances = []; });
    (function() {
        var m = function(t, u) {
            var v = t.document, w = v.getBody(), x = 0, y = function() { x = 1; };
            w.on(u, y);
            (b.version > 7 ? v.$ : v.$.selection.createRange()).execCommand(u);
            w.removeListener(u, y);
            return x;
        }, n = c ? function(t, u) { return m(t, u); } : function(t, u) {
            try {
        ...
        var p = {
            ...
            exec: c ? function(t) {
                ...
                try {
                    ...
                    setTimeout(function() { t.fire('pasteDialog'); }, 0);
                    return false;
                }
            }
        }, q = function(t) {
            ...
            case 2000 + 45:
                ...
                if (!c && u.fire('beforepaste')) t.cancel();
                else if (b.opera || b.gecko && b.version < 10900) u.fire('paste');
                return;
            case 1000 + 88:
            case 2000 + 46:
                var v = this;
                this.fire('saveSnapshot');
                setTimeout(function() { v.fire('saveSnapshot'); }, 0);
            }
        };
        ...
        j.add('clipboard', {
            ...
            init: function(t) {
                t.on('paste', function(y) {
                    var z = y.data;
                    if (z.html) t.insertHtml(z.html);
                    else if (z.text) t.insertText(z.text);
                }, null, null, 1000);
                t.on('pasteDialog', function(y) { setTimeout(function() { t.openDialog('paste'); }, 0); });
    ...
    j.add('colorbutton', {
        ...
        init: function(m) {
            ...
            function q(t, u, v) {
                ...
                m.ui.add(t, 4, {
                    label: v, title: v, className: 'cke_button_' + t.toLowerCase(), modes: { wysiwyg: 1 }, panel: { css: m.skin.editor.css, attributes: { role: 'listbox', 'aria-label': o.panelTitle } },
                    ...
                    onOpen: function() {
                        ...
                        while (u == 'back' && A == 'transparent' && (y = y.getParent()))
            ...
            function r(t, u, v) {
                var w = [], x = n.colorButton_colors.split(','), y = x.length + (n.colorButton_enableMore ? 2 : 1), z = e.addFunction(function(F, G) {
                    ...
                    if (F) {
                        ...
                        J.childRule = G == 'back' ? function(K) { return s(K); } : function(K) { return K.getName() != 'a' || s(K); };
                ...
                proto: {
                    addTarget: function(m, n) {
                        ...
                        m.on('contextmenu', function(s) {
                            ...
                            e.setTimeout(function() { this.open(u, null, v, w); }, 0, this);
                        }, this);
                        if (b.opera)
        ...
        j.add('dialogadvtab', {
            createAdvancedTab: function(o, p) {
                ...
                if (p.styles || p.classes) {
                    ...
                    if (p.styles)
                        s.push({
                            id: 'advStyles', att: 'style', type: 'text', label: q.styles, 'default': '',
    ...
    (function() {
        ...
        j.add('elementspath', {
            ...
            init: function(o) {
                ...
                o.on('themeSpace', function(w) { if (w.data.space == 'bottom') w.data.html += '<span id="' + p + '_label" class="cke_voice_label">' + o.lang.elementsPath.eleLabel + '</span>' + '<div id="' + p + '" class="cke_path" role="group" aria-labelledby="' + p + '_label">' + n + '</div>'; });
                ...
                o.on('selectionChange', function(w) {
                    ...
                    while (z) {
                        ...
                        if (!E) {
                            var G = C.push(z) - 1, H;
                            if (z.data('cke-real-element-type')) H = z.data('cke-real-element-type');
                            else H = z.getName();
                            var I = '';
                ...
                o.on('contentDomUnload', function() { q && q.setHtml(n); });
    ...
    (function() {
        ...
        function q(t) {
            ...
            if (t.getSelection().getStartElement().hasAscendant('pre', true)) {
                setTimeout(function() { o(t, t.config.enterMode, null, true); }, 0);
                return true;
        ...
        function r(t, u, v) {
            ...
            setTimeout(function() {
                t.fire('saveSnapshot');
                if (u == 2 || t.getSelection().getStartElement().hasAscendant('pre', 1)) n(t, u, null, v);
                else o(t, u, null, v);
            }, 0);
            return true;
        }
    ...
    (function() {
        ...
        j.add('flash', {
            init: function(q) {
                ...
                if (q.contextMenu) q.contextMenu.addListener(function(r, s) { if (r && r.is('img') && !r.isReadOnly() && r.data('cke-real-element-type') == 'flash') return { flash: 2 }; });
            },
    ...
    (function() {
        var m = { canUndo: false, exec: function(o) { o.insertElement(o.document.createElement('hr')); } }, n = 'horizontalrule';
        j.add(n, {
            init: function(o) {
                o.addCommand(n, m);
    ...
    (function() {
        ...
        function r(R, S) {
            return function(T) {
                p(T, !R);
                if (q(T, !R, S))
                    if (R || c) T.add(new a.htmlParser.text('\xa0'));
                    else T.add(new a.htmlParser.element('br', { }));
            };
        }
        ...
        var x = {
            ...
            elements: {
                ...
                span: function(R) { if (R.attributes['class'] == 'Apple-style-span') delete R.name; },
                html: function(R) {
            ...
            comment: function(R) {
                if (R.substr(0, n.length) == n) {
                    if (R.substr(n.length, 3) == '{C}') R = R.substr(n.length + 3);
                    else R = R.substr(n.length);
                    return new a.htmlParser.cdata(decodeURIComponent(R));
                }
                return R;
            }
        };
        if (c) x.attributes.style = function(R, S) { return R.toLowerCase(); };
        ...
        function H(R) {
            return R.replace(A, function(S, T, U, V, W) {
                if (V == 'src' && B.test(S)) return S;
                else return '<' + T + U + ' data-cke-saved-' + U + W + '>';
            });
        }
        ...
        function I(R) {
            return R.replace(C, function(S) { return '<cke:encoded>' + encodeURIComponent(S) + '</cke:encoded>'; });
        }

        ;

        function J(R) {
            return R.replace(D, function(S, T) { return decodeURIComponent(T); });
        }
        ...
        function O(R) {
            return R.replace( /<!--(?!{cke_protected})[\s\S]+?-->/g , function(S) { return '<!--' + n + '{C}' + encodeURIComponent(S).replace( /--/g , '%2D%2D') + '-->'; });
        }

        ;

        function P(R) {
            return R.replace( /<!--\{cke_protected\}\{C\}([\s\S]+?)-->/g , function(S, T) { return decodeURIComponent(T); });
        }
        ...
        function Q(R, S) {
            ...
            R = R.replace( /<!--[\s\S]*?-->/g , function(X) { return '<!--{cke_tempcomment}' + (T.push(X) - 1) + '-->'; });
            for (var W = 0;
                W < V.length; W++)
                R = R.replace(V[W], function(X) {
                    X = X.replace(U, function(Y, Z, aa) { return T[aa]; });
                    return '<!--{cke_temp}' + (T.push(X) - 1) + '-->';
                });
            R = R.replace(U, function(X, Y, Z) { return '<!--' + n + (Y ? '{C}' : '') + encodeURIComponent(T[Z]).replace( /--/g , '%2D%2D') + '-->'; });
            return R;
        }
    ...
    (function() {
        ...
        j.add('iframe', {
            ...
            init: function(n) {
                ...
                if (n.contextMenu) n.contextMenu.addListener(function(q, r) { if (q && q.is('img') && q.data('cke-real-element-type') == 'iframe') return { iframe: 2 }; });
            },
            afterInit: function(n) {
                var o = n.dataProcessor, p = o && o.dataFilter;
                if (p) p.addRules({ elements: { iframe: function(q) { return m(n, q); } } });
            }
        });
    })();
    j.add('image', {
                    ...
                    if (ae && ae.length)
                        for (U = 0; U < ae.length; U++) {
                            ...
                            while ((ai = ai.getNext()) && ai.is && ai.getName() in m) {
                                if (c && !ah.getFirst(function(aj) { return n(aj) && o(aj); })) ah.append(D.document.createText('\xa0'));
                                ah.append(ai);
                            }
                            ah.insertAfter(ac);
                        }
    ...
    j.add('link', {
        init: function(m) {
            ...
            m.on('selectionChange', function(n) {
                ...
                if (p && p.getName() == 'a' && p.getAttribute('href')) o.setState(2);
                else o.setState(0);
            });
            m.on('doubleclick', function(n) {
                var o = j.link.getSelectedLink(m) || n.data.element;
                if (!o.isReadOnly())
                    if (o.is('a')) n.data.dialog = o.getAttribute('name') && !o.getAttribute('href') ? 'anchor' : 'link';
                    else if (o.is('img') && o.data('cke-real-element-type') == 'anchor') n.data.dialog = 'anchor';
            });
    ...
    (function() {
        var m = { ol: 1, ul: 1 }, n = /^[\n\r\t ]*$/ , o = d.walker.whitespaces(), p = d.walker.bookmark(), q = function(F) { return !(o(F) || p(F)); };
        j.list = {
            listToArray: function(F, G, H, I, J) {
                ...
                for (var K = 0, L = F.getChildCount(); K < L; K++) {
                    ...
                    for (var O = 0, P = M.getChildCount(), Q; O < P; O++) {
                        Q = M.getChild(O);
                        if (Q.type == 1 && m[Q.getName()]) j.list.listToArray(Q, G, H, I + 1, N.grandparent);
                        else N.contents.push(Q);
                    }
                }
                return H;
            },
            arrayToList: function(F, G, H, I, J) {
                ...
                while (1) {
                    ...
                    if (R.indent == O) {
                        ...
                        P;
                        if (m[R.grandparent.getName()]) P = R.element.clone(false, true);
                        else if (J || R.element.hasAttributes() || I != 2 && R.grandparent.getName() != 'td') {
                            P = K.createElement(Q);
        ...
        function v(F, G, H) {
            ...
            while (K.length) {
                ...
                if (W.is('pre') || u.test(W.getName())) W.appendTo(X);
                else {
                    if (P && W.getDirection()) {
                        W.removeStyle('direction');
                        W.removeAttribute('dir');
            ...
            exec: function(F) {
                ...
                while ((L = Q.getNextRange()) && ++R) {
                    ...
                    while (W = V.getNextParagraph()) {
                        if (W.getCustomData('list_block')) continue;
                        else h.setMarker(P, W, 'list_block', 1);
                        ...
                        if (ab) continue;
                        var ag = ac;
                        if (ag.getCustomData('list_group_object_' + R)) ag.getCustomData('list_group_object_' + R).contents.push(W);
                        else {
                ...
                while (O.length > 0) {
                    af = O.shift();
                    if (this.state == 2) {
                        if (m[af.root.getName()]) t.call(this, F, af, P, ah);
                        else v.call(this, F, af, ah);
        ...
        function B(F) {
            return function(G) {
                ...
                if (K && (K.name && K.name == 'br' || K.value && (L = K.value.match(z)))) {
                    var M = K;
                    if (!(L && L.index) && M == H[0]) H[0] = F || c ? new a.htmlParser.text('\xa0') : new a.htmlParser.element('br', { });
                    else if (M.name == 'br') H.splice(I - 1, 1);
                    else M.value = M.value.replace(z, '');
                }
            };
        }
    ...
    j.add('newpage', {
        init: function(m) {
            m.addCommand('newpage', {
                ...
                exec: function(n) {
                    var o = this;
                    n.setData(n.config.newpage_html || '', function() { setTimeout(function() { n.fire('afterCommandExec', { name: o.name, command: o }); }, 200); });
                    n.focus();
                },
                async: true
            });
    ...
    (function() {
        j.add('pastefromword', {
            init: function(m) {
                var n = 0, o = function() { setTimeout(function() { n = 0; }, 0); };
                ...
                m.on('paste', function(p) {
                    ...
                    if ((r = q.html) && (n || /(class=\"?Mso|style=\"[^\"]*\bmso\-|w:WordDocument)/ .test(r))) {
                        var s = this.loadFilterRules(function() {
                            if (s) m.fire('paste', q);
                            else if (!m.config.pasteFromWordPromptCleanup || n || confirm(m.lang.pastefromword.confirmCleanup)) q.html = a.cleanWord(r, m);
                        });
                        s && p.cancel();
                    }
                }, this);
    ...
    (function() {
        var m = {
            ...
            exec: function(o) {
                ...
                if (q.fullPage) p = o.getData().replace( /<head>/ , '$&' + r).replace( /[^>]*(?=<\/title>)/ , o.lang.preview);
                else {
                ...
                exec: function(m) {
                    ...
                    while (s = r.getNextRange()) {
                        ...
                        while (x) {
                            ...
                            if (!(x.getName() == 'img' && x.data('cke-realelement')) && p(m, x))
                                if (n.test(x.getName())) x.remove(1);
                                else {
    ...
    j.add('resize', {
        init: function(m) {
            ...
            if (n.resize_enabled !== false) {
                ...
                m.on('destroy', function() { e.removeFunction(v); });
    ...
    (function() {
        ...
        var p = function() {
            var t = this, u = function() {
                ...
                C.afterMarkupRemove.push(function(J) { new h(J, C.document).mergeSiblings(); });
        ...
        j.add('scayt', {
            ...
            init: function(t) {
                ...
                if (y[2] == 1)
                    D.scaytDict = {
                        label: E.dictionariesTab, group: C,
                        onClick: function() {
                            n = 'dictionaries';
                            t.openDialog(m);
                        }
                ...
                if (t.contextMenu && t.addMenuItems)
                    t.contextMenu.addListener(function(G, H) {
                        ...
                        for (var S = 0, T = N.length; S < T; S += 1) {
                            var U = 'scayt_suggestion_' + N[S].replace(' ', '_'), V = (function(Z, aa) { return { exec: function() { I.replace(Z, aa); } }; })(J, N[S]);
                            if (S < Q) {
                        ...
                        if (P) {
                            t.addMenuItem('scayt_moresuggest', { label: E.moreSuggestions, group: 'scayt_moresuggest', order: 10, getItems: function() { return u; } });
                            v.scayt_moresuggest = 2;
                        }
                        if (o('all', R) || o('ignore', R)) {
                            var W = { exec: function() { I.ignore(J); } };
                            r(t, 'ignore', E.ignore, 'scayt_ignore', W, 'scayt_control', 1);
                            v.scayt_ignore = 2;
                        }
                        if (o('all', R) || o('ignoreall', R)) {
                            var X = { exec: function() { I.ignoreAll(J); } };
                            r(t, 'ignore_all', E.ignoreAll, 'scayt_ignore_all', X, 'scayt_control', 2);
                            v.scayt_ignore_all = 2;
                        }
                        if (o('all', R) || o('add', R)) {
                            var Y = { exec: function() { window.scayt.addWordToUserDictionary(J); } };
                ...
                var F = function() {
                    ...
                    if (!b.opera && !b.air) w.setState(q.isScaytEnabled(t) ? 1 : 2);
                    else w.setState(0);
                };
                t.on('showScaytState', F);
                if (b.opera || b.air) t.on('instanceReady', function() { F(); });
    ...
    j.sourcearea = {
        commands: {
            source: {
                modes: { wysiwyg: 1, source: 1 }, editorFocus: false,
                exec: function(m) {
            ...
            init: function(n) {
                ...
                n.ui.addRichCombo('Styles', {
                    ...
                    onClick: function(t) {
                        ...
                        if (u.type == 2 && u.checkActive(w)) u.remove(n.document);
                        else if (u.type == 3 && u.checkActive(w)) u.remove(n.document);
                        else u.apply(n.document);
                        n.fire('saveSnapshot');
                    },
                    onRender: function() {
            ...
            init: function(G) {
                ...
                G.addCommand('tableDelete', {
                    exec: function(I) {
                        ...
                        J.selectRanges([M]);
                        var N = L.getParent();
                        if (N.getChildCount() == 1 && !N.is('body', 'td', 'th')) N.remove();
                        else L.remove();
                    }
                });
                ...
                if (G.addMenuItems)
                    G.addMenuItems({
                        ...
                        tablecolumn: { label: H.column.menu, group: 'tablecolumn', order: 1, getItems: function() { return { tablecolumn_insertBefore: 2, tablecolumn_insertAfter: 2, tablecolumn_delete: 2 }; } },
    ...
    (function() {
        ...
        j.add('tab', {
            ...
            init: function(q) {
                ...
                if (r) q.on('key', function(u) { if (u.data.keyCode == 9 && q.execCommand('selectNextCell') || u.data.keyCode == 2000 + 9 && q.execCommand('selectPreviousCell')) u.cancel(); });
                if (b.webkit || b.gecko)
                    q.on('key', function(u) {
                ...
                o.on('themeSpace', function(q) {
                    if (q.data.space == o.config.toolbarLocation) {
                        ...
                        for (var x = 0; x < w.length; x++) {
                            ...
                            for (var C = 0; C < y.length; C++) {
                                ...
                                if (D) {
                                    ...
                                    F.toolbar = A;
                                    F.onkey = p;
                                    F.onfocus = function() { if (!o.toolbox.focusCommandExecuted) o.focus(); };
                                }
                            }
                            if (u) {
                                s.push('</span>');
                        ...
                        if (o.config.toolbarCanCollapse) {
                            var G = e.addFunction(function() { o.execCommand('toolbarCollapse'); });
                            o.on('destroy', function() { e.removeFunction(G); });
                            var H = e.getNextId();
    ...
    (function() {
        j.add('undo', {
            ...
            init: function(s) {
                ...
                s.on('saveSnapshot', function() { t.save(); });
                ...
                s.on('updateSnapshot', function() { if (t.currentImage && new m(s).equals(t.currentImage)) setTimeout(function() { t.update(); }, 0); });
            }
        });
        j.undo = { };
    ...
    (function() {
        ...
        function q(E) {
            if (E.getType() == 3) return E.getSelectedElement().isReadOnly();
            else return E.getCommonAncestor().isReadOnly();
        }
        ...
        function v(E) {
            if (!E.checkDirty()) setTimeout(function() { E.resetDirty(); }, 0);
        }
        ...
        function D(E) {
            ...
            Q.evaluator = function(S) { return S.type == 1 && S.getName() in m; };
            Q.guard = function(S, T) { return !(S.type == 3 && w(S) || T); };
            if (Q.previous()) {
                F.fire('updateSnapshot');
                v(F);
                c && A(I);
                var R;
                if (L != 2) R = K.append(new h(L == 1 ? 'p' : 'div'));
                else R = K;
                if (!c) R.appendBogus();
            }
        }
        ...
        j.add('wysiwygarea', {
            ...
            init: function(E) {
                ...
                E.on('editingBlockReady', function() {
                    ...
                    function W(X) {
                        ...
                        if (c) {
                            ...
                            setTimeout(function() {
                                if (b.gecko && b.version >= 10900 || b.opera) Y.$.body.contentEditable = true;
                                else if (b.webkit) Y.$.body.parentNode.contentEditable = true;
                                else Y.$.designMode = 'on';
                            }, 0);
                        ...
                        if (b.webkit) {
                            Y.on('click', function(af) { if (af.data.getTarget().is('input', 'select')) af.data.preventDefault(); });
                            Y.on('mouseup', function(af) { if (af.data.getTarget().is('input', 'textarea')) af.data.preventDefault(); });
                        }
                        ...
                        X.on('blur', function() { E.focusManager.blur(); });
                        var ac;
                        X.on('focus', function() {
                            var af = E.document;
                            if (b.gecko && b.version >= 10900) L();
                        ...
                        if (c) {
                            ...
                            if (Y.$.compatMode == 'CSS1Compat') {
                                var ae = { 33: 1, 34: 1 };
                                Y.on('keydown', function(af) { if (af.data.getKeystroke() in ae) setTimeout(function() { E.getSelection().scrollIntoView(); }, 0); });
                            }
                        }
                        ...
                        setTimeout(function() {
                            ...
                            setTimeout(function() { E.fire('dataReady'); }, 0);
                            try {
                    ...
                    E.addMode('wysiwyg', {
                        ...
                        getData: function() {
                            ...
                            if (X.ignoreEmptyParagraph)
                                ab = ab.replace(n, function(ac, ad) {
                                    return ad;
                                });
                            if (Z) ab = Z + '\n' + ab;
                            return ab;
                        },
                        getSnapshotData: function() { return O.getFrameDocument().getBody().getHtml(); },
                        loadSnapshotData: function(X) { O.getFrameDocument().getBody().setHtml(X); },
                        onDispose: function() {
                        ...
                        focus: function() {
                            var X = E.window;
                            if (P) Q = true;
                            else if (b.opera && E.document) {
                                var Y = E.window.$.frameElement;
                                Y.blur(), Y.focus();
                                E.document.getBody().focus();
                                E.selectionChange();
                            } else if (!b.opera && X) {
                                b.air ? setTimeout(function() { X.focus(); }, 0) : X.focus();
                                E.selectionChange();
                            }
                        }
                    });
                ...
                E.on('insertElement', function(N) {
                    var O = N.data;
                    if (O.type == 1 && (O.is('input') || O.is('textarea')))
                        if (!O.isReadOnly()) {
                            O.setAttribute('contentEditable', false);
    ...
    (function() {
        ...
        a.dialog = function(P, Q) {
            ...
            this.parts = W.parts;
            e.setTimeout(function() { P.fire('ariaWidget', this.parts.contents); }, 0, this);
            ...
            if (R.onOk)
                this.on('ok', function(an) {
                    P.fire('saveSnapshot');
                    setTimeout(function() { P.fire('saveSnapshot'); }, 0);
                    if (R.onOk.call(this, an) === false) an.data.hide = false;
                });
            if (R.onCancel) this.on('cancel', function(an) { if (R.onCancel.call(this, an) === false) an.data.hide = false; });
            ...
            function ad() {
                ...
                an.sort(function(aq, ar) {
                    if (aq.tabIndex != ar.tabIndex) return ar.tabIndex - aq.tabIndex;
        ...
        function r(P, Q, R) {
            ...
            this.focusIndex = R;
            this.tabIndex = 0;
            this.isFocusable = function() { return !Q.getAttribute('disabled') && Q.isVisible(); };
            this.focus = function() {
                P._.currentFocusIndex = this.focusIndex;
                this.element.focus();
            };
            Q.on('keydown', function(S) { if (S.data.getKeystroke() in { 32: 1, 13: 1 }) this.fire('click'); });
            Q.on('focus', function() { this.fire('mouseover'); });
            Q.on('blur', function() { this.fire('mouseout'); });
        }
        ...
        a.dialog.prototype = {
            ...
            show: function() {
                ...
                if (b.gecko && b.version < 10900) {
                    ...
                    setTimeout(function() { T.setStyle('position', 'fixed'); }, 0);
                }
                ...
                J(this, this, '\x1b', null, function() { this.getButton('cancel') && this.getButton('cancel').click(); });
                ...
                e.setTimeout(function() {
                    ...
                    this.foreach(function(W) { W.setInitValue && W.setInitValue(); });
                }, 100, this);
            },
            layout: function() {
                var R = this;
            ...
            reset: (function() {
                var P = function(Q) { if (Q.reset) Q.reset(1); };
                return function() {
                    this.foreach(P);
                    return this;
                };
            ...
            setupContent: function() {
                var P = arguments;
                this.foreach(function(Q) { if (Q.setup) Q.setup.apply(Q, P); });
            },
            commitContent: function() {
                var P = arguments;
                this.foreach(function(Q) { if (Q.commit) Q.commit.apply(Q, P); });
            },
            hide: function() {
                ...
                this.foreach(function(U) { U.resetInitValue && U.resetInitValue(); });
            },
            addPage: function(P) {
                var ab = this;
            ...
            hidePage: function(P) {
                ...
                if (!Q || R._.pageCount == 1 || !Q.isVisible()) return;
                else if (P == R._.currentTabId) R.selectPage(o.call(R));
                Q.hide();
                R._.pageCount--;
                R.updateStyle();
            },
            ...
            getValueOf: function(P, Q) { return this.getContentElement(P, Q).getValue(); },
            setValueOf: function(P, Q, R) { return this.getContentElement(P, Q).setValue(R); },
            getButton: function(P) { return this._.buttons[P]; },
            click: function(P) { return this._.buttons[P].click(); },
            disableButton: function(P) { return this._.buttons[P].disable(); },
            enableButton: function(P) { return this._.buttons[P].enable(); },
        ...
        e.extend(a.dialog, {
            add: function(P, Q) { if (!this._.dialogDefinitions[P] || typeof Q == 'function') this._.dialogDefinitions[P] = Q; },
            exists: function(P) { return !!this._.dialogDefinitions[P]; },
            getCurrent: function() { return a.dialog._.currentTop; },
            okButton: (function() {
                var P = function(Q, R) {
                    R = R || { };
                    return e.extend({
                        id: 'ok', type: 'button', label: Q.lang.common.ok, 'class': 'cke_dialog_ui_button_ok',
                        onClick: function(S) {
                            var T = S.data.dialog;
                ...
                P.type = 'button';
                P.override = function(Q) { return e.extend(function(R) { return P(R, Q); }, { type: 'button' }, true); };
                return P;
            })(),
            ...
            addUIElement: function(P, Q) { this._.uiElementBuilders[P] = Q; }
        });
        ...
        w.prototype = { getContents: function(P) { return t(this.contents, P); }, getButton: function(P) { return t(this.buttons, P); }, addContents: function(P, Q) { return u(this.contents, P, Q); }, addButton: function(P, Q) { return u(this.buttons, P, Q); }, removeContents: function(P) { v(this.contents, P); }, removeButton: function(P) { v(this.buttons, P); } };
        ...
        ;
        x.prototype = { get: function(P) { return t(this.elements, P, 'children'); }, add: function(P, Q) { return u(this.elements, P, Q, 'children'); }, remove: function(P) { v(this.elements, P, 'children'); } };
        ...
        function y(P) {
            ...
            function W(Y) {
                ...
                R.y += ae;
                if (R.x + V[3] < U) af = -V[3];
                else if (R.x - V[1] > aa.width - Z.width - U) af = aa.width - Z.width + (T.lang.dir == 'rtl' ? 0 : V[1]);
                else af = R.x;
                if (R.y + V[0] < U) ag = -V[0];
                else if (R.y - V[2] > aa.height - Z.height - U) ag = aa.height - Z.height + V[2];
                else ag = R.y;
                P.move(af, ag, 1);
        ...
        function z(P) {
            ...
            P.on('load', function() {
                var ac = '';
                if (R == 1) ac = ' cke_resizer_horizontal';
                else if (R == 2) ac = ' cke_resizer_vertical';
            ...
            S.on('destroy', function() { e.removeFunction(Z); });
            ...
            function ab() {
                ...
                if (S.lang.dir == 'rtl') {
                    ...
                    if (ae == 'auto') ae = V.width - parseInt(ad.getStyle('right'), 10) - P.getSize().width;
                    else ae = parseInt(ae, 10);
        ...
        }, L = function(P, Q) { if (P._.accessKeyMap[Q]) P.selectPage(P._.accessKeyMap[Q]); }, M = function(P, Q) {
        }, N = { 27: 1, 13: 1 }, O = function(P) { if (P.data.getKeystroke() in N) P.data.stopPropagation(); };
        (function() {
            k.dialog = {
                uiElement: function(P, Q, R, S, T, U, V) {
                    ...
                    if (typeof Q.isChanged == 'boolean') this.isChanged = function() { return Q.isChanged; };
                    ...
                    if (this.keyboardFocusable) {
                        ...
                        this.on('focus', function() { P._.currentFocusIndex = ai.focusIndex; });
                    }
                    e.extend(this, Q);
                },
        ...
        k.dialog.uiElement.prototype = {
            ...
            registerEvents: function(P) {
                var Q = /^on([A-Z]\w+)/ , R, S = function(U, V, W, X) { V.on('load', function() { U.getInputElement().on(W, X, U); }); };
                for (var T in P) {
                    if (!(R = T.match(Q))) continue;
                    if (this.eventProcessors[T]) this.eventProcessors[T].call(this, this._.dialog, P[T]);
                    else S(this, this._.dialog, R[1].toLowerCase(), P[T]);
                }
                return this;
            },
            eventProcessors: { onLoad: function(P, Q) { P.on('load', Q, this); }, onShow: function(P, Q) { P.on('show', Q, this); }, onHide: function(P, Q) { P.on('hide', Q, this); } },
            accessKeyDown: function(P, Q) { this.focus(); },
        ...
        a.dialogCommand = function(P) { this.dialogName = P; };
        a.dialogCommand.prototype = { exec: function(P) { P.openDialog(this.dialogName); }, canUndo: false, editorFocus: c || b.webkit };
        (function() {
            var P = /^([a]|[^a])+$/ , Q = /^\d*$/ , R = /^\d*(?:\.\d+)?$/ ;
            a.VALIDATE_OR = 1;
            a.VALIDATE_AND = 2;
            a.dialog.validate = {
                ...
                notEmpty: function(S) { return this.regex(P, S); },
                integer: function(S) { return this.regex(Q, S); },
                number: function(S) { return this.regex(R, S); },
                equals: function(S, T) { return this.functions(function(U) { return U == S; }, T); },
                notEqual: function(S, T) { return this.functions(function(U) { return U != S; }, T); }
            };
    ...
    (function() {
        ...
        a.style.prototype = {
            apply: function(R) { Q.call(this, R, false); },
            remove: function(R) { Q.call(this, R, true); },
            ...
            applyToObject: function(R) { H(R, this); },
        ...
        function p(R) {
            ...
            while (R = R.getParent()) {
                ...
                if (R.getAttribute('data-cke-nostyle')) S = R;
                else if (!T) {
        ...
        function q(R) {
            ...
            while (ac) {
                ...
                if (ag && ad && !ad.collapsed) {
                    var ao = G(av, S), ap = ao.hasAttributes(), aq = ad.getCommonAncestor(), ar = { styles: { }, attrs: { }, blockedStyles: { }, blockedAttrs: { } }, as, at, au;
                    while (ao && aq) {
                        if (aq.getName() == U) {
                            for (as in V.attributes) {
                                if (ar.blockedAttrs[as] || !(au = aq.getAttribute(at))) continue;
                                if (ao.getAttribute(as) == au) ar.attrs[as] = 1;
                                else ar.blockedAttrs[as] = 1;
                            }
                            for (at in V.styles) {
                                if (ar.blockedStyles[at] || !(au = aq.getStyle(at))) continue;
                                if (ao.getStyle(at) == au) ar.styles[at] = 1;
                                else ar.blockedStyles[at] = 1;
                            }
                        }
                        aq = aq.getParent();
                    }
        ...
        function r(R) {
            ...
            if (R.collapsed) {
                ...
                if (V) {
                    ...
                    for (W = 0; true; W++) {
                        var aa = U.elements[W];
                        if (aa.equals(V)) break;
                        else if (aa.match) continue;
                        else aa = aa.clone();
                        aa.append(Z);
                        Z = aa;
                    }
                ...
                while (!ae.equals(ab)) {
                    ...
                    if (ae.type == 1 && this.checkElementRemovable(ae)) {
                        if (ae.getName() == this.element) C(this, ae);
                        else E(ae, L(this)[ae.getName()]);
        ...
        function y(R) {
            var S = /(\S\s*)\n(?:\s|(<span[^>]+data-cke-bookmark.*?\/span>))*\n(?!$)/gi , T = R.getName(), U = z(R.getOuterHtml(), S, function(W, X, Y) { return X + '</pre>' + Y + '<pre>'; }), V = [];
            U.replace( /<pre\b.*?>([\s\S]*?)<\/pre>/gi , function(W, X) { V.push(X); });
            return V;
        }
        ...
        function A(R, S) {
            ...
            for (var U = 0; U < R.length; U++) {
                ...
                V = z(V, /^[ \t]+|[ \t]+$/g , function(X, Y, Z) {
                    ...
                    else if (!Y) return e.repeat('&nbsp;', X.length - 1) + ' ';
                    else return ' ' + e.repeat('&nbsp;', X.length - 1);
                });
                V = V.replace( /\n/g , '<br>');
                V = V.replace( /[ \t]{2,}/g , function(X) { return e.repeat('&nbsp;', X.length - 1) + ' '; });
                var W = S.clone();
                W.setHtml(V);
                T.append(W);
            }
        ...
        function J(R, S) {
            for (var T in R) R[T] = R[T].replace(I, function(U, V) { return S[V]; });
        }
        ...
        function L(R) {
            ...
            if (T) {
                ...
                for (var U = 0; U < T.length; U++) {
                    var V = T[U], W, X, Y;
                    if (typeof V == 'string') W = V.toLowerCase();
                    else {
        ...
        function O(R) {
            var S = { };
            R.replace( /&quot;/g , '"').replace( /\s*([^ :;]+)\s*:\s*([^;]+)\s*(?=;|$)/g , function(T, U, V) { S[U] = V; });
            return S;
        }
        ...
        m.prototype = {
            getNextParagraph: function(p) {
                ...
                while (C) {
                    ...
                    if (!F) {
                        ...
                        if (C.isBlockBoundary(this.forceBrBreak && !E && { br: 1 })) {
                            if (H == 'br') F = 1;
                            else if (!r && !C.getChildCount() && H != 'hr') {
                                q = C;
                                s = C.equals(y);
                                break;
                            }
                ...
                if (!q) {
                    ...
                    q = J.block;
                    if (!q && !this.enforceRealBlocks && L[K.getName()] && r.checkStartOfBlock() && r.checkEndOfBlock()) q = K;
                    else if (!q || this.enforceRealBlocks && q.getName() == 'li') {
                ...
                if (u) {
                    var O = q.getPrevious();
                    if (O && O.type == 1)
                        if (O.getName() == 'br') O.remove();
                        else if (O.getLast() && O.getLast().$.nodeName.toLowerCase() == 'br') O.getLast().remove();
                }
                if (v) {
                    var P = q.getLast();
                ...
                if (!N(this._.nextNode)) this._.nextNode = this._.nextNode.getNextSourceNode(true, null, function(Q) { return !Q.equals(y) && N(Q); });
                return q;
            }
        };
        d.range.prototype.createIterator = function() { return new m(this); };
    })();
    j.add('panelbutton', { requires: ['button'], beforeInit: function(m) { m.ui.addHandler(4, k.panelButton.handler); } });
    a.UI_PANELBUTTON = 4;
    (function() {
        var m = function(n) {
            var p = this;
            ...
            proto: {
                ...
                show: function(n, o, p, q) {
                    ...
                    if (!t) {
                        ...
                        this._.itemOutFn = e.addFunction(function(F) { clearTimeout(this._.showSubTimeout); }, this);
    ...
    (function() {
        var m = function(o, p) { return o._.modes && o._.modes[p || o.mode]; }, n;
        j.add('editingblock', {
            init: function(o) {
                if (!o.config.editingBlock) return;
                o.on('themeSpace', function(p) { if (p.data.space == 'contents') p.data.html += '<br>'; });
                o.on('themeLoaded', function() { o.fireOnce('editingBlockReady'); });
                o.on('uiReady', function() { o.setMode(o.config.startupMode); });
                ...
                o.on('getSnapshot', function(p) { if (o.mode) p.data = m(o).getSnapshotData(); });
                o.on('loadSnapshot', function(p) { if (o.mode) m(o).loadSnapshotData(p.data); });
                o.on('mode', function(p) {
                    p.removeListener();
                    b.webkit && o.container.on('focus', function() { o.focus(); });
    ...
    (function() {
        ...
        var r = {
            ...
            exec: function(t) {
                ...
                case 'source':
                    var u = t.textarea.$;
                    if (c) u.createTextRange().execCommand('SelectAll');
                    else {
                        u.selectionStart = 0;
            ...
            init: function(t) {
                t.on('contentDom', function() {
                    ...
                    if (c) {
                        ...
                        w.on('mousedown', function() { z = 0; });
                        w.on('mouseup', function() { z = 1; });
                        if (c && (b.ie7Compat || b.version < 8 || b.quirks)) w.on('click', function(D) { if (D.data.getTarget().getName() == 'html') t.getSelection().getRanges()[0].select(); });
                        var A;
        ...
        d.selection.prototype = {
                    ...
                    var u = function(v, w) {
                        ...
                        for (var A = 0; A < y.length; A++) {
                            ...
                            if (B.nodeType == 1) {
                                ...
                                z.collapse();
                                if (C > 0) break;
                                else if (!C || D == 1 && C == -1) return { container: x, offset: A };
                        ...
                        if (E === 0) return { container: x, offset: A };
                        else return { container: y[A], offset: -E };
                    };
                    return function() {
                        var F = this;
                ...
                return function(u) {
                    ...
                    if (u) {
                        ...
                        for (var x = 0; x < w.length; x++) {
                            ...
                            if (A && A.type == 3)
                                if (C >= A.getLength()) E.setStartAfter(A);
                                else E.setStartBefore(A);
                            if (B && B.type == 3)
                                if (!D) E.setEndBefore(B);
                                else E.setEndAfter(B);
                    ...
                    if (w) {
                        if (!w.collapsed) {
                            ...
                            while (1) {
                                ...
                                if (y == (x.getChildCount ? x.getChildCount() : x.getLength()) && !x.isBlockBoundary()) w.setStartAfter(x);
                                else break;
                            }
                            u = w.startContainer;
                            if (u.type != 1) return u.getParent();
                            u = u.getChild(w.startOffset);
                            if (!u || u.type != 1) u = w.startContainer;
                            else {
                                var z = u.getFirst();
                                while (z && z.type == 1) {
                                    u = z;
            ...
            getSelectedElement: function() {
                ...
                var u = this, v = e.tryThese(function() { return u.getNative().createRange().item(0); }, function() {
            ...
            unlock: function(t) {
                ...
                if (v) {
                    ...
                    if (t) {
                        ...
                        y.reset();
                        u.getBody().focus();
                        if (w) y.selectElement(w);
                        else y.selectRanges(x);
                    }
                }
                if (!v || !t) {
                    y.isLocked = 0;
            ...
            createBookmarks: function(t) { return this.getRanges().createBookmarks(t); },
            createBookmarks2: function(t) { return this.getRanges().createBookmarks2(t); },
    ...
    j.add('richcombo', { requires: ['floatpanel', 'listblock', 'button'], beforeInit: function(m) { m.ui.addHandler(3, k.richCombo.handler); } });
    a.UI_RICHCOMBO = 3;
    k.richCombo = e.createClass({
        ...
        proto: {
            ...
            render: function(m, n) {
                ...
                m.on('mode', function() { this.setState(this.modes[m.mode] ? 2 : 0); }, this);
    ...
    k.prototype.addRichCombo = function(m, n) { this.add(m, 3, n); };
    j.add('htmlwriter');
    ...
    j.add('menubutton', { requires: ['button', 'menu'], beforeInit: function(m) { m.ui.addHandler(5, k.menuButton.handler); } });
    a.UI_MENUBUTTON = 5;
    (function() {
        var m = function(n) {
            var o = this._;
        ...
        e.extend(k.dialog, {
            labeledElement: function(u, v, w, x) {
                ...
                var z = this._.children = [], A = function() {
                    ...
                    if (v.labelLayout != 'horizontal') B.push('<label class="cke_dialog_ui_labeled_label' + C + '" ', ' id="' + y.labelId + '"', ' for="' + y.inputId + '"', ' style="' + v.labelStyle + '">', v.label, '</label>', '<div class="cke_dialog_ui_labeled_content" role="presentation">', x.call(this, u, v), '</div>');
                    else {
    ...
    j.add('panel', { beforeInit: function(m) { m.ui.addHandler(2, k.panel.handler); } });
    a.UI_PANEL = 2;
    ...
    k.panel.prototype = {
        ...
        showBlock: function(m) {
            ...
            o.onMark = function(r) { q.setAttribute('aria-activedescendant', r.getId() + '_option'); };
            o.onUnmark = function() { q.removeAttribute('aria-activedescendant'); };
            o.show();
            return o;
        },
    ...
    a.themes.add('default', (function() {
        ...
        function m(n, o) {
            ...
            if (q) {
                ...
                if (q.getCustomData('cke_hasshared')) s.hide();
                else q.setCustomData('cke_hasshared', 1);
                ...
                n.on('destroy', function() { s.remove(); });
            }
            return p;
        }
