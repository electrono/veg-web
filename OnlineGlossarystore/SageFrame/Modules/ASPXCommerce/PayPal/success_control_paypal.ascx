<%@ Control Language="C#" AutoEventWireup="true" CodeFile="success_control_paypal.ascx.cs" Inherits="Modules_ASPXCommerce_ASPXPaymentSuccess_success_control_paypal" %>
