...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        LoadAllTagsStaticImage();
        BindTagDetails(null, null);
        GetStatusOfTag();
            ...
            if (itemTags_Ids != "") {
                var properties = {
                    onComplete: function(e) {
                        ConfirmDeleteMultipleItemTags(itemTags_Ids, e);
                    }
                }
    ...
    function LoadAllTagsStaticImage() {
...
//        }
    ...
    function BindTagDetails(tags, tagStatus) {
        var offset_ = 1;
        var current_ = 1;
        ...
        $("#gdvTags").sagegrid({
            ...
            functionMethod: 'GetTagDetailsList',
            colModel: [
    ...
    function ConfirmDeleteMultipleItemTags(Ids, event) {
        DeleteItemTagInfo(Ids, event);
    }

    function DeleteItemTagInfo(_TagID_Ids, event) {
        if (event) {
            var params = { itemTagIDs: _TagID_Ids, storeID: storeId, portalID: portalId };
            var mydata = JSON2.stringify(params);
            $.ajax({
                type: "POST",
                url: aspxservicePath + "ASPXCommerceWebService.asmx/DeleteMultipleTag",
                data: mydata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function() {
    ...
    function BindResults() {
        ...
        $.each(arrTagItemsToBind, function(index, value) {
            if (value.ImagePath == "") {
                value.ImagePath = '<%= noImageAllTagsPath %>';
            }
...
<div class="cssClassBodyContentWrapper" id="divShowTagDetails">
    <div class="cssClassCommonBox Curve">
        <div class="cssClassHeader">
            <h2>
                <asp:Label ID="lblTitle" runat="server" Text="Manage Tags"></asp:Label>
            </h2>
