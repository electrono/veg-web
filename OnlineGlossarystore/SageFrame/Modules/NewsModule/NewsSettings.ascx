            ...
            <ContentTemplate>
                ...
                <div class="cssClassFormWrapper">
                    <table>
                        <tr>
                            <td width="20%">
                                <asp:Label ID="lblNewsModuleTitle" runat="server" CssClass="cssClassFormLabel"
                                           Text="News Module Title:" meta:resourcekey="lblNewsModuleTitleResource1"></asp:Label></td>
                            <td>                                    
                                <asp:TextBox ID="txtNewsModuleTitle" runat="server" 
                                             CssClass="cssClassNormalTextBox" meta:resourcekey="txtNewsModuleTitleResource1"></asp:TextBox>
                        ...
                        <tr>
                            <td width="20%">
                                <asp:Label ID="lblDefaultSorting" runat="server" CssClass="cssClassFormLabel" 
                                           Text="Default Sorting:" meta:resourcekey="lblDefaultSortingResource1"></asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlDefaultSorting" runat="server" 
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblDateFormat" runat="server" CssClass="cssClassFormLabel" 
                                           Text="Date Format:" meta:resourcekey="lblDateFormatResource1"></asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlDateFormat" runat="server" CssClass="cssClassDropDown" 
                                                  meta:resourcekey="ddlDateFormatResource1">
                                </asp:DropDownList>
                            </td>
                            <td>
                            </td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblNumberOfNews" runat="server" CssClass="cssClassFormLabel" 
                                           Text="Number of News:" meta:resourcekey="lblNumberOfNewsResource1"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtNumberOfNews" runat="server" 
                                             CssClass="cssClassNormalTextBox" meta:resourcekey="txtNumberOfNewsResource1"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfvNumberOfNews" runat="server" ErrorMessage="*"
                                                            ...
                                                            CssClass="cssClassNormalRed" meta:resourcekey="rfvNumberOfNewsResource1"></asp:RequiredFieldValidator>
                            </td>
                            <td>
                                <asp:RegularExpressionValidator ID="revNumberOfNews" runat="server" 
                                                                ControlToValidate="txtNumberOfNews" ErrorMessage="Number Required." 
                                                                ValidationExpression="^\d+$" CssClass="cssClassNormalRed" 
                                                                meta:resourcekey="revNumberOfNewsResource1"></asp:RegularExpressionValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="lblMoreNewsText" runat="server" CssClass="cssClassFormLabel" 
                                           Text="More News Text:" meta:resourcekey="lblMoreNewsTextResource1"></asp:Label></td>
                            <td>
                                <asp:TextBox ID="txtMoreNewsText" runat="server" 
                                             CssClass="cssClassNormalTextBox" meta:resourcekey="txtMoreNewsTextResource1"></asp:TextBox>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblMoreNewsPageName" runat="server" CssClass="cssClassFormLabel" 
                                           Text="More News Page Name:" 
                                           meta:resourcekey="lblMoreNewsPageNameResource1"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtMoreNewsPageName" runat="server" 
                                ...
                                <asp:RequiredFieldValidator ID="rfvMoreNewsPageName" runat="server" 
                                                            ...
                                                            SetFocusOnError="True" ValidationGroup="newssetting" 
                                                            CssClass="cssClassNormalRed" meta:resourcekey="rfvMoreNewsPageNameResource1"></asp:RequiredFieldValidator>
                            </td>
                            <td>
                            </td>
                        </tr>
            ...
            <ContentTemplate>
                ...
                <div class="cssClassFormWrapper">
                    <table>
                        <tr>
                            <td width="20%">
                                <asp:Label ID="lblNewsCategoryLists" runat="server" CssClass="cssClassFormLabel"
                                           Text="News Category To Show:" 
                                           meta:resourcekey="lblNewsCategoryListsResource1"></asp:Label>
                            </td>
                            <td>
                                <asp:ListBox ID="lstNewsCategoryLists" runat="server" CssClass="cssClassDropDown "
                                             SelectionMode="Multiple" ValidationGroup="categorysetting" 
                                             meta:resourcekey="lstNewsCategoryListsResource1"></asp:ListBox>
                            </td>
                            <td>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="lblMaxNumberOfCategory" runat="server" CssClass="cssClassFormLabel"
                                           Text="Maximum Number of Category:" 
                                           meta:resourcekey="lblMaxNumberOfCategoryResource1"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtMaxNumberOfCategory" runat="server" 
                                             CssClass="cssClassNormalTextBox" 
                                ...
                                <asp:RequiredFieldValidator ID="rfvMaxNumberOfCategory" runat="server" ErrorMessage="*"
                                                            ...
                                                            meta:resourcekey="rfvMaxNumberOfCategoryResource1"></asp:RequiredFieldValidator>
                            </td>
                            <td>
                                <asp:RegularExpressionValidator ID="rfvNumberOfCategory1" runat="server" ControlToValidate="txtMaxNumberOfCategory"
                                                                ErrorMessage="Number Required." ValidationExpression="^\d+$" 
                                                                ValidationGroup="categorysetting" CssClass="cssClassNormalRed" 
                                                                meta:resourcekey="rfvNumberOfCategory1Resource1"></asp:RegularExpressionValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="lblIconSize" runat="server" CssClass="cssClassFormLabel" 
                                           Text="Category Icon Size:" meta:resourcekey="lblIconSizeResource1"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtIconSize" runat="server" CssClass="cssClassNormalTextBox" 
                                             meta:resourcekey="txtIconSizeResource1"></asp:TextBox><asp:Label ID="lblImageSize"
                                                                                                              runat="server" CssClass="cssClassFormLabel" Text="(KB) " 
                                                                                                              meta:resourcekey="lblImageSizeResource1"></asp:Label>
                            </td>
                            <td>
                                <asp:RequiredFieldValidator ID="rfvIconSize" runat="server" ControlToValidate="txtIconSize"
                                ...
                                <asp:RegularExpressionValidator ID="rfvIconSize1" runat="server" ControlToValidate="txtIconSize"
                                                                ErrorMessage="Number Required." ValidationExpression="^\d+$" 
                                                                ValidationGroup="categorysetting" CssClass="cssClassNormalRed" 
                                                                meta:resourcekey="rfvIconSize1Resource1"></asp:RegularExpressionValidator>
                            </td>
                        </tr>
                    </table>
                    <div class="cssClassButtonWrapper">
