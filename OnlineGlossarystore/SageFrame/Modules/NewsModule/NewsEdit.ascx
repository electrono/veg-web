...
<ajax:TabContainer ID="TabContainerNewsEdit" runat="server" ActiveTabIndex="0" 
    ...
    <ajax:TabPanel ID="TabPanelManageNews" runat="server" 
        ...
        <ContentTemplate>
            <asp:Label ID="lblManageNewsHelp" runat="server" CssClass="cssClassHelpTitle" 
                    ...
                    <table id="tblManageNews" cellspacing="2" cellpadding="2" border="0" runat="server"
                        ...
                        <tr runat="server">
                            <td valign="top" runat="server">
                                <asp:Label ID="lblNewsType" runat="server" Text="News Type:" CssClass="cssClassFormLabel"></asp:Label>
                            </td>
                            <td runat="server">
                                <asp:DropDownList ID="ddlNewsType" runat="server" CssClass="cssClassDropDown">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr runat="server">
                            <td valign="top" runat="server">
                                <asp:Label ID="lblNewsCategory" runat="server" Text="News Category:" CssClass="cssClassFormLabel"></asp:Label>
                            </td>
                            <td runat="server">
                                <asp:DropDownList ID="ddlCategory" runat="server" CssClass="cssClassDropDown">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr runat="server">
                            <td valign="top" runat="server">
                                <asp:Label ID="lblNewsTitle" runat="server" Text="News Title:" CssClass="cssClassFormLabel"></asp:Label>
                            </td>
                            <td runat="server">
                                <asp:TextBox ID="txtNewsTitle" runat="server" CssClass="cssClassNormalTextBox"
                                ...
                                <asp:RequiredFieldValidator ID="rfvNewsTitle" runat="server" ControlToValidate="txtNewsTitle"
                                                            ...
                                                            SetFocusOnError="True" ValidationGroup="text"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr runat="server">
                            <td valign="top" runat="server">
                                <asp:Label ID="lblNewsShortDescription" runat="server" Text="News Short Description:"
                                           CssClass="cssClassFormLabel"></asp:Label>
                            </td>
                            <td runat="server">
                                <asp:TextBox ID="txtNewsShortDescription" runat="server" Width="304px" CssClass="cssClassNormalTextBox"
                        ...
                        <tr runat="server">
                            <td valign="top" runat="server">
                                <asp:Label ID="lblAddLongDescription" runat="server" Text="News in Detail:" CssClass="cssClassFormLabel"></asp:Label>
                            </td>
                            <td runat="server">
                                <FCKeditorV2:FCKeditor ID="txtLongDesc" runat="server" Height="350px" Width="100%">
                        ...
                        <tr runat="server">
                            <td valign="top" runat="server">
                                <asp:Label ID="lblNewsDate" runat="server" Text="News Date:" CssClass="cssClassFormLabel"></asp:Label>
                            </td>
                            <td runat="server">
                                <table cellpadding="0" cellspacing="0" border="0" class="cssClassFormCalendar">
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtNewsDate" runat="server" CssClass="cssClassNormalTextBox" MaxLength="11" />
                                        </td>
                                        <td>
                                            <ajax:CalendarExtender ID="cmdNewsCalendar" runat="server" CssClass="CssClassCalendar"
            ...
            <asp:Panel ID="pnlNewsInGrid" runat="server" Width="100%" 
                ...
                <div class="cssClassFormWrapper">
                    ...
                    <asp:DropDownList ID="ddlNewsCatList" runat="server" CssClass="cssClassDropDown"
                                      AutoPostBack="True" 
                            ...
                            <asp:TemplateField meta:resourcekey="TemplateFieldResource5">
                                <ItemTemplate>
                                    <asp:ImageButton ID="imbDelete" runat="server" CausesValidation="False" CommandArgument='<%# Eval("NewsID") %>'
                                                     CommandName="Delete" ToolTip="Delete News" ImageUrl='<%# GetTemplateImageUrl("imgdelete.png", true) %>' 
    ...
    <ajax:TabPanel ID="TabPanelManageNewsCategory" runat="server" 
        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlManageNewsCategory" runat="server" 
                ...
                <div class="cssClassGridWrapper">
                    <asp:GridView Width="100%" runat="server" ID="gdvManageNewsCategory" DataKeyNames="NewsCategoryID"
                                  CssClass="cssClassGridWrapper" OnSelectedIndexChanged="gdvManageNewsCategory_SelectedIndexChanged"
            ...
            <asp:Panel ID="pnlAddNewsCategory" runat="server" 
                ...
                <div class="cssClassFormWrapper">
                    <table class="cssClassNormal" id="tblManageCategories" border="0">
                        <tr id="rowNewsCategoryID" runat="server" visible="False">
                            <td valign="top" runat="server">
                                <asp:Label ID="lblNewsCategoryID" runat="server" Text="NewsCategoryID" CssClass="cssClassFormLabel"></asp:Label>
                            </td>
                            <td runat="server">
                                <asp:Label ID="lblNewsCatID" runat="server"></asp:Label>
                                <asp:HiddenField ID="hdfNewsCategoryID" runat="server" />
                            </td>
                            <td runat="server">
                            </td>
                        </tr>
                        <tr>
                            <td valign="top">
                                <asp:Label ID="lblCategoryName" runat="server" Text="News Category Name:" 
                        ...
                        <tr>
                            <td valign="top" height="53">
                                <asp:Label ID="lblCategoryDescription" runat="server" Text="News Category Description:"
                                           CssClass="cssClassFormLabel" 
                                           meta:resourcekey="lblCategoryDescriptionResource1"></asp:Label>
                            </td>
                            <td height="53">
                        ...
                        <tr>
                            <td valign="top">
                                <asp:Label ID="lblIcon" runat="server" Text="News Category Image:" 
                                           CssClass="cssClassFormLabel" meta:resourcekey="lblIconResource1"></asp:Label>
                            </td>
                            <td valign="top">
                                <asp:FileUpload ID="fluNewsCategory" runat="server" 
                                                meta:resourcekey="fluNewsCategoryResource1" />
                                <asp:Label ID="lblError" runat="server" EnableViewState="False" 
                                           ForeColor="#FF3300" meta:resourcekey="lblErrorResource1"></asp:Label>
                            </td>
                            <td style="text-align: left">
                                <asp:Image ID="ImgNewsCategory" runat="server" Visible="False" 
                                           meta:resourcekey="ImgNewsCategoryResource1" />
                            </td>
                        </tr>
                        <tr>
                            <td valign="top">
                            ...
                            <td>
                                <asp:CheckBox ID="chkPublish" runat="server" Checked="True" 
                                              cssClass="cssClassCheckBox" meta:resourcekey="chkPublishResource1" />
                            </td>
                            <td valign="top">
                            </td>
                        </tr>
