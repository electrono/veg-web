...
public partial class Localization_Language : BaseAdministrationUserControl
{
    ...
    public void Initialize()
    {
        ...
        jsArrColl.Add(appPath + "/js/encoder.js");   
		...
		IncludeCssFile(AppRelativeTemplateSourceDirectory + "css/pagination.css");
    ...
    public void HookEventHandlers()
    {
        ...
        ctrl_MenuEditor.CancelButtonClick += new ImageClickEventHandler(ctrl_MenuEditor_CancelClick);
       
    }
    private void AddImageUrl()
    {
        imbAddLanguage.ImageUrl = GetTemplateImageUrl("btnadd.png", true);
        imbInstallLang.ImageUrl = GetTemplateImageUrl("imginstall.png", true);
        imbCreateLangPack.ImageUrl = GetTemplateImageUrl("btncreatepackage.png", true);
        imbEditTimeZone.ImageUrl = GetTemplateImageUrl("btnedittimezone.png", true);
        imbCancel.ImageUrl = GetTemplateImageUrl("btncancel.png", true);
        imbDeleteResxFile.ImageUrl = GetTemplateImageUrl("btndelete.png", true);
    ...
    {       
        ...
        try
        {
            ...
            ShowMessage(SageMessageTitle.Notification.ToString(), GetSageMessage("LanguageModule", "LanguageIsEnabled"), "", SageMessageType.Alert);
        }
        catch (Exception ex)
        {
            ProcessException(ex);
    ...
    private void BindTree()
    {
        ...
        rootNodeGlobal2.Expanded = false;
    ...
    protected void tvList_SelectedNodeChanged(object sender, EventArgs e)
    {
        ...
        {
            ShowMessage(SageMessageTitle.Exception.ToString(), GetSageMessage("LanguageModule", "ResourceFileCouldNotBeRead"), "", SageMessageType.Error);
        }
    ...
    protected void imbUpdate_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            InitializeTreeview();
            ShowMessage(SageMessageTitle.Information.ToString(), GetSageMessage("LanguageModule", "ResourceFileSavedSuccessfully"), "", SageMessageType.Success);
            imbDeleteResxFile.Visible = false;
            lblDeleteResx.Visible = false;
            imbUpdate.Visible = false;
            lblUpdateResxFile.Visible = false;
    ...
    protected void imbDeleteResxFile_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            if(!LocalizationHelper.IsDefaultFile(filePath))
            {
                ...
                ShowMessage(SageMessageTitle.Information.ToString(), GetSageMessage("LanguageModule", "ResourceFileDeletedSuccessfully"), "", SageMessageType.Success);
                InitializeTreeview();
            ...
            {
                ShowMessage(SageMessageTitle.Information.ToString(), GetSageMessage("LanguageModule", "DefaultFileCannotBeDeleted"), "", SageMessageType.Alert);
